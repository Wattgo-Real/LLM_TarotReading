...
if __name__ == "__main__":
    # Setup paths
    image_dir = "C:/Users/User/Desktop/dataset_train"
    label_dir = "C:/Users/User/Desktop/dataset_train" # They are in the same dir
    
    # Organize for RT-DETRv2 (create a dedicated coco folder)
    coco_root = "C:/Users/User/Desktop/coco_tarot"
    ...
    tarot_img_dir = "./TarotImg"
    tarot_images = glob.glob(os.path.join(tarot_img_dir, "*.webp"))
    tarot_images.sort()
    class_names = [os.path.basename(p) for p in tarot_images] + [f"r_{os.path.basename(p)}" for p in tarot_images]
